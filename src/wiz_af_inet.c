...
/* wiz network interface operations registered */
int sal_netif_wiz_ops_register(struct sal_netif *netif)
{
    RT_ASSERT(netif);

    netif->family = AF_WIZ;
    netif->skt_ops = &wiz_socket_ops;
    netif->netdb_ops = &wiz_netdb_ops;
